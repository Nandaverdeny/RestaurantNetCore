...
.PARAMETER Clean
Removes the image dotnetcore_postgresql and kills all containers based on that image.
...
Build a Docker image named dotnetcore_postgresql
#>
...
$imageName="dotnetcore_postgresql"
$projectName="dotnetcorepostgresql"
$serviceName="dotnetcore_postgresql"
